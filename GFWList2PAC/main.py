...
# gfwlist_url = 'https://raw.githubusercontent.com/gfwlist/gfwlist/master/gfwlist.txt' # ban with gfw, you need proxy to access
gfwlist_url = 'https://dl.sunriseydy.top/pac/GFWList2PAC/gfwlist.txt'
